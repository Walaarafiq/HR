...
function GovermentsDepartmentTable() {
  const initialEmployees = [
    { id: 1, GovName: "إقتصاد كلي", EmpNum: "1 موظف"},
    { id: 2, GovName: "الأرشيف المركزي", EmpNum: "10 موظفين"},
    { id: 3, GovName: "الأجهزة والبرامج", EmpNum: "3 موظفين"},
];
...
export default GovermentsDepartmentTable;

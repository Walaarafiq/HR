...
function Programs2Table() {
  const initialEmployees = [
    { id: 1, GovName: "موظفين عقود على بند التشغيل الطارئ", EmpNum: "1 موظف"},
    { id: 2, GovName: "موظفين غير موزعين على برنامج", EmpNum: "10 موظفين"},
    { id: 3, GovName: "لا يمتلك قيمة", EmpNum: "3 موظفين"},
];
